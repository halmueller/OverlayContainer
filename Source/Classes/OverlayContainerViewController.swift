...
public class OverlayContainerViewController: UIViewController {
    ...
    public enum OverlayStyle {
        ...
        case rigid
        /// The overlay view controller will be constrained with a height at least equal to the highest notch.
        /// Its height will be expanded when the overlay goes above the highest notch.
